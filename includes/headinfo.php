...
<meta name="description" content="PCB design with Passion, Altium, Altium designer, KiCAD, y-tronic.ch">
	...
	<meta name="keywords" lang="de" content="projekte realisieren, PCB-design, 3D Druck, Webseiten selber programmieren">
    ...
    <link href="https://fonts.googleapis.com/css?family=Hind|Karla|Roboto" rel="stylesheet">

    <?php
        echo '<link rel="stylesheet" type="text/css" href="css/css_all.css" />';
        echo '<link rel="stylesheet" type="text/css" href="css/css_nav.css" />';
		echo '<link rel="stylesheet" type="text/css" href="css/css_navigation.css" />';
    ?>
